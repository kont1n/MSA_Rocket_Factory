...
func (_m *InventoryClient) ListParts(ctx context.Context, filter *model.Filter) (*[]model.Part, error) {
...
func (_c *InventoryClient_ListParts_Call) RunAndReturn(run func(context.Context, *model.Filter) (*[]model.Part, error)) *InventoryClient_ListParts_Call {
	_c.Call.Return(run)
	return _c
}
